...
const AuthNavigator = () => {
	return (
		...
		>
			...
			/>
			<Stack.Screen name={AuthScreenNames.Profile} component={ProfileScreen} />
			<Stack.Screen name={AuthScreenNames.Game} component={ExercicesScreen} />
			...
			/>
			<Stack.Screen name={AuthScreenNames.ChatScreen} component={ChatScreen} />
			<Stack.Screen
