...
export const useRegisterAnimations = (isFieldFocused: boolean) => {
  // Global animations
  ...
  useEffect(() => {
    ...
    if (isFieldFocused) {
      ...
      Animated.parallel([
        ...
        // Remove formSlideAnim to let KeyboardAvoidingView handle positioning
        ...
        // Footer stays visible when keyboard appears
