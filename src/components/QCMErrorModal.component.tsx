...
const QCMErrorModal: React.FC<QCMErrorModalProps> = ({
	isVisible,
	correctAnswer,
	onClose,
}) => {
		...
		>
			<View style={styles.content}>
				...
				<View style={styles.textContainer}>
					<Text style={[styles.headerText, styles.errorText]}>
						{t("qcm.error.title")}
					</Text>
					<Text style={styles.subText}>{t("qcm.error.subtitle")}</Text>
					<View style={styles.answerContainer}>
						<Ionicons name="bulb" size={18} color="#4CAF50" />
						<Text style={styles.answerLabel}>
							{t("qcm.error.correctAnswer")}
						</Text>
					</View>
			...
			<TouchableOpacity
				...
				activeOpacity={0.8}
			>
				<Text style={styles.buttonText}>{t("qcm.error.continue")}</Text>
				<Ionicons
					name="arrow-forward"
					size={20}
					color="#FFF"
