			...
			<View style={styles.badgesRow}>
				...
				<View style={[styles.badgeCard, { opacity: 0.5 }]}>
					<View
						style={[
							styles.badgeImage,
							{ backgroundColor: "#EEE", borderRadius: 35 },
						]}
					/>
					<TypographyComponent variant="labelSmall" style={{ marginTop: 8 }}>
						{t("profileStats.comingSoon")}
					</TypographyComponent>
				</View>
			</View>
		</View>
