...
import { HomeTabsParamList } from "@app/navigation/Auth/authNavigator.model";
import {
  type FriendPlayer,
  type RankingPlayer,
} from "@features/duel/hooks/useDuelScreen";
import { DuelChallenge, DuelHistoryItem } from "@features/duel/store/duel.model";
