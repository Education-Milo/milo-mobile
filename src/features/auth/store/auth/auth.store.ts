...
import { AuthStore } from '@features/auth/store/auth/auth.model';
    ...
    (set, get) => ({
      ...
      login: async (email, password) => {
        try {
          ...
          const { useUserStore } = await import('@features/user/store/user.store');
      ...
      register: async (email, password, last_name, first_name, role, classe, username) => {
        try {
