...
import ChapterCard from "@features/course/components/ChapterCard.component";
import BottomSheetComponent from "@shared/components/BottomSheetModal.component";
import { colors } from "@shared/theme/colors";
import ChapterAccordion from "@features/course/components/Lesson/ChapterAccordion.component";
import LoadingScreen from "@shared/components/LoadingScreen";
import { useLessonChapterScreen } from "@features/course/hooks/useLessonChapterScreen";
				...
				<ScrollView contentContainerStyle={styles.scrollContent}>
					<TouchableOpacity style={styles.backButton} onPress={handleGoBack}>
						...
						<TypographyComponent variant="h6" style={{ marginLeft: 8 }}>
							{t("lessonChapter.back")}
						</TypographyComponent>
					</TouchableOpacity>

					<ChapterCard userName={user?.first_name} courseTitle={matiere} />
					...
					<View style={styles.modalContent}>
						...
						<View style={styles.optionsContainer}>
							...
							>
								...
								>
									{t("lessonChapter.learnDescription")}
								</TypographyComponent>
							</TouchableOpacity>
							...
							>
								...
								<TypographyComponent
									...
									style={{ textAlign: "center" }}
								>
									{t("lessonChapter.practiceDescription")}
								</TypographyComponent>
							</TouchableOpacity>
						</View>
					</View>
