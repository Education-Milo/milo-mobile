...
import { Chapter, Course, Lesson } from '@features/course/store/course.model';
import { fetchChapters, fetchLessons, useCourses, useSubjects } from '@features/course/api/course.queries';
