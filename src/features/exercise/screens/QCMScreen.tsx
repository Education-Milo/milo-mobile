...
import QCMErrorModal from "@shared/components/QCMErrorModal.component";
import QCMSuccessModal from "@shared/components/QCMSuccessModal.component";
import { colors } from "@shared/theme/colors";
import useQCMScreen, { Question } from "@features/exercise/hooks/useQCMScreen";
...
const QCMScreen: React.FC<QCMScreenProps> = ({
	questions,
	onQuizComplete,
	onQuit,
}) => {
									...
									<Text
										style={[
											...
											selectedAnswer === option &&
												styles.selectedOptionIndicatorText,
										]}
									>
